...
<body>
	...
	<div class="mainContainer">
		...
		<div class="formulario">
			<form action="operaciones.jsp?tipo=altaSocio" method="post">
			  <div class="form-row">
			  	<div class="form-group col-md-6">
			      <label for="dni">Dni del Socio<span class="required" title="Campo requerido" >*</span></label>
			  ...
			  <div class="form-row">
			  	<div class="form-group col-md-6">
			    	...
			    	<input type="Email" class="form-control" required id="email" name="email" placeholder="abcde123@example.com">	
				</div>
			  	<div class="form-group col-md-6">
