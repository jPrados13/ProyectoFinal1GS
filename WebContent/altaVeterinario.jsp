...
<body>
	...
	<div class="mainContainer">
		...
		<div class="formulario">
			<form action="operaciones.jsp?tipo=altaVeterinario" method="post">
			  <div class="form-row">
			  	<div class="form-group col-md-6">
			      <label for="dni">Dni del Veterinario<span class="required" title="Campo requerido" >*</span></label>
			  ...
			  <div class="form-row">
			    ...
			    <div class="form-group col-md-6">
			      ...
			      <input type="text" class="form-control" required id="especialidad" name="especialidad" maxlength="30" placeholder="Oncología">
			    </div>
			  </div>
