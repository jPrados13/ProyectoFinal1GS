...
<% ArrayList<Local> locales = controladorBD.dameLocales();
	int nChip  = Integer.parseInt(request.getParameter("chipLocal"));%>
<% Gato gato = controladorBD.dameGatoLocal(nChip); %>
<!DOCTYPE html>
<html>
<head>
	<title>Modificar Gato Local</title>
...
<body>
	...
	<div class="mainContainer">
		...
		<div class="formulario">
			<form action="operaciones.jsp?tipo=modifigl" method="post">
