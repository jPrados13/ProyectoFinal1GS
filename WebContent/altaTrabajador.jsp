...
<body>
	...
	<div class="mainContainer">
		...
		<div class="formulario">
			<form action="operaciones.jsp?tipo=altaTrabajador" method="post">
			  <div class="form-row">
			  ...
			  <div class="form-row">
			      ...
			      <input type="number" required class="form-control" id="nss" name="nss" pattern="[0-9]{12,12}" placeholder="890123456789">
			    </div>
				<div class="form-group col-md-6">
