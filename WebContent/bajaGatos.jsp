...
<body>
	...
	<div class="mainContainer">
		...
		<a href="gatosGatoteca.jsp"><h2 class="subtitle">Ahora en La Gatoteca</h2></a>
		<hr>
		<div class="gatos">
		<%for(int i = 0; i < gatosLocal.size(); i++) { %>
			<div class="card" style="width: 18rem;">
			  ...
			  <div class="card-body">
			    ...
			    <form action="operaciones.jsp?tipo=bajagl" method="post">
		...
		<hr>
		<a href="gatosAdoptados.jsp"><h2 class="subtitle">Ya Adoptados</h2></a>
		<hr>
		<div class="gatos">
			...
			<div class="card" style="width: 18rem;">
			  ...
			  <div class="card-body">
			    ...
			    <form action="operaciones.jsp?tipo=bajaga" method="post">
