...
<body>
	...
	<div class="mainContainer">
		...
		<div class="formulario">
			<form action="operaciones.jsp?tipo=altaga" method="post">
			  <div class="form-row">
			  	<div class="form-group col-md-6">
			      <label for="nChip">Numero de chip<span class="required" title="Campo requerido" >*</span></label>
			      <input type="number" required max="99999999" class="form-control" id="nChip" name="nChip" pattern="[0-9]{8,8}" placeholder="00000000">
			    </div>
			    <div class="form-group col-md-6">
			      <label for="nombre">Nombre<span class="required" title="Campo requerido" >*</span></label>
			      <input type="text" class="form-control" required id="nombre" name="nombre" maxlength="20" placeholder="Misifu" >
			    </div>
			  </div>
			  <div class="form-row">
			  	<div class="form-group col-md-6">
			    	<label for="edad">Edad <span class="required" title="Campo requerido" >*</span></label>
			    	<input type="number" step="0.5" required class="form-control" max="99.9" id="edad" name="edad" placeholder="2.0"  >
				</div>
			  	<div class="form-group col-md-6">
			  ...
			  <div class="form-row">
			  	<div class="form-group col-md-6">
				   	<label for="dniAdop">Dni del adoptante<span class="required" title="Campo requerido" >*</span></label>
				   	<select id="dniAdop" name="dniAdop" class="form-control" required>
			  ...
			  <div class="form-row">
			  	<div class="form-group col-md-6">
				   	...
				   	<textarea class="form-control" id="descripcion" name="descripcion" maxlength="100" rows="3"></textarea>
				</div>
			  </div>
