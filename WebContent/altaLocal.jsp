...
<body>
	...
	<div class="mainContainer">
		...
		<div class="formulario">
			<form action="operaciones.jsp?tipo=altaLocal" method="post">
			  <div class="form-row">
			    <div class="form-group col-md-6">
			      <label for="calle">Calle<span class="required" title="Campo requerido" >*</span></label>
			      <input type="text" class="form-control" required id="calle" name="calle" maxlength="50" placeholder="C/Falsa 123">
			    </div>
			  </div>
			  <div class="form-row">
			  	<div class="form-group col-md-6">
			    	<label for="tlf">telefono<span class="required" title="Campo requerido" >*</span></label>
			    	<input type="number"  required class="form-control" max="999999999" id="tlf" name="tlf" placeholder="911563489" >
				</div>
			  </div>
			  <div class="form-row">
			  	<div class="form-group col-md-6">
			    	<label for="aforoP">Aforo Personas<span class="required" title="Campo requerido" >*</span></label>
			    	<input type="number"  required class="form-control" max="999" id="aforoP" name="aforoP" placeholder="20" >
				</div>
				<div class="form-group col-md-6">
			    	<label for="aforoG">Aforo Gatos<span class="required" title="Campo requerido" >*</span></label>
			    	<input type="number"  required class="form-control" max="999" id="aforoG" name="aforoG" placeholder="20" >
				</div>
			  </div>
